...
const RunningLine: FC<IRunningLine> = forwardRef(function RunningLine(
  ...
  return !isMounted ? null : (
    ...
    >
      {overlay && (
        <div className={styles.overlayStyle} style={overlayProperties}></div>
      )}
      <div className={styles.text} style={rotatinText} ref={marqueeRef}>
        {Children.map(children, (item) => {
          return (
            <div className={styles.Card} style={marginCards}>
              {" "}
              {item}{" "}
            </div>
          );
      ...
      <div className={styles.text} style={rotatinText} aria-hidden="true">
        {Children.map(children, (item) => {
          return (
            <div className={styles.Card} style={marginCards}>
              {" "}
