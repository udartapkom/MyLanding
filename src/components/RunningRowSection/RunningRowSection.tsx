...
const RunningRowSection = () => {
  return (
    <section className={styles.RunningRowSection}>
      <h2 className={styles.RunningRowSection_header}>
      ...
      <RunningLine
        ...
        distanceCards={40}
      >
        <RunningCard text={"React"}>
          <ReactIcon />
        </RunningCard>
        <RunningCard text={"Next"}>
          <NextIcon />
        </RunningCard>
        <RunningCard text={"NodeJS"}>
          <NodeIcon />
        </RunningCard>
        <RunningCard text={"SAAS"}>
          <SaasIcon />
        </RunningCard>
        <RunningCard text={"MongoDB"}>
          <MongoIcon />
        </RunningCard>
        <RunningCard text={"Redux"}>
          <ReduxIcon />
        </RunningCard>
        <RunningCard text={"TypeScript"}>
          <TSIcon />
        </RunningCard>
        <RunningCard text={"JavaScript"}>
          <JSIcon />
        </RunningCard>
        <RunningCard text={"NPM"}>
          <NPMIcon />
        </RunningCard>
